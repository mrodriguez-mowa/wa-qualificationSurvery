      ...
      <div className="bg-light-dark shadow-md rounded px-8 pt-8 pb-6 mb-4">
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
            ...
            <input className="text-dark-primary placeholder:text-gray-500 appearance-none block w-full bg-gray-200  border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-username" type="text" placeholder="user@example.com" />
          </div>
